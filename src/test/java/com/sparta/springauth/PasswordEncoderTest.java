...
public class PasswordEncoderTest {
    ...
    @Autowired // springauth.config.PasswordEncoder에 등록한 @Bean 객체를 주입
    ...
    void test1() {
        ...
        // plaintext password
        String passwordToLogin = "Robbie";

        // 복호화를 통해 암호화된 비밀번호와 비교
        boolean matches = passwordEncoder.matches(passwordToLogin, encodedPassword);
